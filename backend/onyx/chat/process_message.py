...
from onyx.chat.self_healing import run_with_healing
...
def build_chat_turn(
    ...
    *,
    ...
    custom_agent_prompt = get_custom_agent_prompt(persona, chat_session, db_session)
    ...
    from onyx.db.prompt_registry import fetch_effective_prompt
    active_version = fetch_effective_prompt("persona", str(persona.id), db_session, chat_session.id if chat_session else None)
    if active_version:
        persona_system_prompt = active_version.content
    ...
    def _run_model(model_idx: int) -> None:
        ...
        try:
            ...
            if n_models == 1 and setup.new_msg_req.deep_research:
                ...
                setup_info = {
                    "session_id": setup.chat_session.id,
                    "agent_id": setup.persona.id if setup.persona else None,
                ...
                run_with_healing(
                    ...
                    tools=model_tools,
                    custom_agent_prompt=setup.custom_agent_prompt,
                    persona_system_prompt=setup.persona_system_prompt,
