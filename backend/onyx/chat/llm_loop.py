    ...
    with trace(
        ...
        for llm_cycle_count in range(MAX_LLM_CYCLES):
            ...
            if persona and persona.replace_base_system_prompt:
                ...
                # Use the provided persona_system_prompt (which may come from registry)
                # or fallback to persona.system_prompt
                sys_prompt_content = persona_system_prompt if persona_system_prompt is not None else persona.system_prompt
                
                system_prompt = (
                    ChatMessageSimple(
                        message=sys_prompt_content,
                        token_count=token_counter(sys_prompt_content),
