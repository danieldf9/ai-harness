...
def generate_chat_session_name(
    ...
    with llm_generation_span(
        ...
        # Remove any reasoning blocks (e.g. <thought> or <think>) that some models may generate
        new_name_raw = re.sub(r'<(?:thought|think)>.*?(?:</(?:thought|think)>|$)', '', new_name_raw, flags=re.DOTALL | re.IGNORECASE)
