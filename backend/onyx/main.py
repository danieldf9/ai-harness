...
from onyx.server.manage.prompt_registry import router as prompt_registry_router
from onyx.server.manage.search_settings import router as search_settings_router
from onyx.server.manage.self_learning import router as self_learning_router
...
def get_application(lifespan_override: Lifespan | None = None) -> FastAPI:
    ...
    include_router_with_global_prefix_prepended(application, self_learning_router)
    include_router_with_global_prefix_prepended(
    ...
    include_router_with_global_prefix_prepended(application, prompt_registry_router)
    include_router_with_global_prefix_prepended(
